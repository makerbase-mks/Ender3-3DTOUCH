...
// This option inserts short delays between lines of serial output.
  #define SERIAL_OVERRUN_PROTECTION    //改
...
//#define I2C_SLAVE_ADDRESS  0 // Set a value from 8 to 127 to act as a slave   改
